...
Claude Code users can add hook scripts for automatic session management, tool counting, and handoff detection. These hooks extend the protocol with automated chain spawning when context fills up and structured handoffs between sessions. See [INSTALL-GUIDE.md](INSTALL-GUIDE.md) for details.
